...
public class UploadUtil {
     ...
     * @return 返回响应的内容
     */
    public static String uploadFile(File file, String RequestURL,String affix) {
        String result = null;
        ...
        try {
            ...
            if (file != null) {
                ...
                sb.append("Content-Disposition: form-data; name=\"upload\";affix=\""+affix+"\";filename=\"" + file.getName() + "\"" + LINE_END);
